...
from open_deep_research_he.configuration import MultiAgentConfiguration
...
from open_deep_research_he.prompts import SUPERVISOR_INSTRUCTIONS, RESEARCH_INSTRUCTIONS
